...
class Geyser extends Appliance{
  double temperature;
  String geyser_mode;

  Geyser(boolean power,double temperature,String geyser_mode){
        if(power){
              on();
        }else{
              off();
  ...
  public void setGeyserMode(String geyser_mode){
        this.geyser_mode = geyser_mode;
  }
...
class WashingMachine extends Appliance{
  ...
  WashingMachine(boolean power,String washing_mode,String water_temperature){
        if(power){
              on();
        }else{
              off();
  ...
  public void setWaterTemperature(String water_temperature){
        this.water_temperature = water_temperature;
  }
...
class Kitchen extends MyHome{
  ...
  public void display(){
      System.out.println(microwave_1.PowerLevel);
      System.out.println(dishwasher_1.Watertemp);
      System.out.println(mixer_1.speed);
      System.out.println(RO.replacement_status);
  }
  
}


class Bathroom extends MyHome{
  Light bathroom_light_1 = new Light(true,95,"warm white");
  Geyser geyser = new Geyser(false,42.3,"Heating");
  WashingMachine washing_machine = new WashingMachine(true,"normal","warm");

  Bathroom(String name_val){
        super(name_val);
  }

  public void display(){
        System.out.println(bathroom_light_1.power);
        System.out.println(bathroom_light_1.brightness);
        System.out.println(geyser.power);
        System.out.println(geyser.temperature);
        System.out.println(geyser.geyser_mode);
        System.out.println(washing_machine.power);
        System.out.println(washing_machine.washing_mode);
...
public class Final{
  public static void main(String[] args){
    ...
    Bedroom bedroom_1 = new Bedroom("MyHome");
    System.out.println(bedroom_1.room_ac.temperature);
    System.out.println(bedroom_1.room_computer.power);
    System.out.println("BATHROOM");
    Bathroom bathroom1 = new Bathroom("MyHome");
    bathroom1.display();
